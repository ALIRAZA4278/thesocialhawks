        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
                {/* Instagram */}
                <a target='_blank' href="https://www.instagram.com/socialhawks" className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors group">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary">Instagram</span>
                </a>
                ...
                <a href="#" target='_blank' className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors group">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary">Facebook</span>
                </a>
                ...
                <a href="#" target='_blank' className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors group">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-primary">LinkedIn</span>
                </a>

                {/* YouTube */}
                <a href="https://www.youtube.com/@thesocialhawks" target='_blank' className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors group">
                  <div className="w-8 h-8 mb-2">
                    <svg viewBox="0 0 24 24" fill="currentColor" className="w-full h-full text-gray-400 group-hover:text-primary">
                      <path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/>
                    </svg>
                  </div>
                  <span className="text-sm text-gray-400 group-hover:text-primary">YouTube</span>
                </a>
              </div>
            </div>
          </div>

        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 pt-8 border-t border-gray-800">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto">
                {/* Instagram */}
                <a href="https://www.instagram.com/socialhawks" className="flex flex-col items-center justify-center bg-gray-800 rounded-lg p-6 hover:bg-gray-700 transition-colors group">

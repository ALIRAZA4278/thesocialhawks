          ...
          <div className="px-4">
            ...
            <div className="mb-6">
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>/</span>
                <span className="text-gray-900 font-medium">Mobile App Development</span>
              </div>
            </div>
            ...
            >
              <div className="text-left flex-1">
                ...
                <p className="text-xl text-gray-700 leading-relaxed mb-8">
                  Today&apos;s digital economy has turned businesses to more than just static websites; they now want to have powerful, scalable, and secure mobile applications. SocialHawks is the company that specializes in custom mobile app development services, and we create innovative applications that help in the automation of tasks, enhancement of customer experience, and consequently the growth of businesses.
                </p>
          ...
          <div className="px-4 mx-auto max-w-6xl">
                ...
                {[
                  {
                    ...
                    description: "We create and develop personalized mobile applications that address actual business issues — ranging from customer relationship management (CRM) and inventory management systems to cutting-edge software as a service (SaaS) platforms."
                  },
                  {
                    title: "Mobile Application Development Service",
                    description: "Our complete mobile application development service applies to every step from the planning stage to UI/UX design, writing the code, system integration, and launching the application."
                  },
                  {
                    title: "Best Mobile Application Development Services",
                    description: "The use of modern plus most up-to-date frameworks and technologies (React Native, Flutter, Swift, Kotlin, Xamarin) helps us to provide the best mobile application development services that also come with advanced features."
                  },
                  {
                    title: "Application Development Services for Enterprises",
                    description: "Our application development services are not limited to one category of customer; they can be broad enough to cover clients ranging from newly established businesses to big multinational enterprises."
                  }
                ].map((service, idx) => (
                  <motion.div
                    key={idx}
                ...
                {[
                  {
                    ...
                    desc: "Native iOS apps using Swift and Objective-C for iPhone and iPad",
                    features: ["App Store Optimization", "iOS Design Guidelines", "Swift & SwiftUI"]
                  },
                  {
                    icon: "🤖",
                    title: "Android App Development",
                    desc: "Native Android apps using Kotlin and Java for all Android devices",
                    features: ["Google Play Optimization", "Material Design", "Kotlin & Java"]
                  },
                  {
                    icon: "🔄",
                    title: "Cross-Platform Development",
                    desc: "Single codebase for iOS and Android using React Native or Flutter",
                    features: ["Cost-Effective", "Faster Development", "React Native & Flutter"]
                  }
                ].map((platform, idx) => (
                  <motion.div
                    key={idx}
                    className="bg-gradient-to-br from-primary/5 to-primary/10 p-6 rounded-xl hover:shadow-lg transition-shadow duration-300"
                    initial={{ opacity: 0, y: 20 }}
                    whileInView={{ opacity: 1, y: 0 }}
                    viewport={{ once: true }}
                    transition={{ delay: idx * 0.1 }}
                  >
                    ...
                    <h3 className="font-bold text-gray-900 mb-2 text-xl">{platform.title}</h3>
                    <p className="text-gray-700 mb-4">{platform.desc}</p>
            ...
            <section className="mb-16">
              <motion.h2
                ...
                viewport={{ once: true }}
              >
                Why SocialHawks Should Be Your Mobile App Development Partner?
              </motion.h2>
                ...
                {[
                  {
                    ...
                    description: "Understanding your business goals, target audience, and app requirements."
                  },
                  {
                    step: "02",
                    title: "UI/UX Design",
                    description: "Creating intuitive and engaging user interfaces with seamless user experience."
                  },
                  {
                    step: "03",
                    title: "Development",
                    description: "Building robust mobile applications using cutting-edge technologies and frameworks."
                  },
                  {
                    step: "04",
                    title: "Testing & QA",
                    description: "Rigorous testing across devices, platforms, and scenarios to ensure quality."
                  },
                  {
                    step: "05",
                    title: "Deployment",
                    description: "Publishing your app to App Store and Google Play with proper optimization."
                  },
                  {
                    step: "06",
                    title: "Support & Maintenance",
                    description: "Ongoing updates, bug fixes, and feature enhancements post-launch."
                  }
                ].map((process, idx) => (
                  <motion.div
                    key={idx}
                  ...
                  >
                    <div className="flex items-start gap-4">
                      <div className="text-4xl font-bold text-primary/50 flex-shrink-0">{process.step}</div>
                      <div>
            ...
            <section className="text-center py-16 bg-gradient-to-br from-primary/10 to-primary/5 rounded-3xl">
              ...
              >
                ...
                <p className="text-lg text-gray-600 mb-8">
                  Discuss your bespoke mobile app development project with our professionals today.
                </p>
                <motion.div
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}

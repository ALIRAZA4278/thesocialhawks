  ...
  const subServices = [
    {
      ...
      shortDescription: "Stand out with custom, creative logo design services. Our logo design agency can create a unique logo that promotes brand identity for your small businesses in any industry.",
      description: "A quality brand starts with a quality logo. We specialize in professional logo design service that represents your brand's identity and makes a lasting impression on customers.",
    ...
    },
    {
      ...
      slug: "brand-development-services",
      shortDescription: "Elevate your company's image with expert branding services. We create brand identities that foster trust and expansion through strategy and design.",
      description: "A brand transcends a mere logo; it's the whole story, the sound of its voice, the bond developed with the public. We help companies manufacture substantial identities and win customer loyalty.",
      image: "/images/services/brand-development.jpg",
      fallback: "linear-gradient(135deg, #764ba2 0%, #667eea 100%)",
      features: [
            ...
            >
              ...
              <div className="text-left lg:max-w-md lg:flex-shrink-0">
                <p className="text-lg text-gray-600 leading-relaxed">
                  Professional logo design and brand development services that create memorable
                  brand identities. Build recognition, trust, and lasting connections with your audience
                  through strategic brand development and custom logo design.
                </p>
              </div>
            </motion.div>
          </div>
          ...
          <div className="px-4 mx-auto">
            ...
            >
              ...
              <p className="text-gray-600 max-w-2xl mx-auto">
                Choose from our specialized brand identity and design services
              </p>
            </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              {subServices.map((service, index) => (
                <Link href={`/services/brand-identity-design/${service.slug}`} key={service.id} className="block">
                  <motion.div
        ...
        >
          <div className="max-w-5xl mx-auto px-6">
            ...
            <p className="text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              We combine strategic thinking with creative excellence to deliver brand solutions
              that not only look exceptional but perform effectively in competitive markets.
            </p>

            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {[
                { icon: "🎯", title: "Strategic Approach", desc: "Market research and positioning strategy" },
                { icon: "⚡", title: "Fast Turnaround", desc: "Quick delivery without compromising quality" },
                { icon: "🏆", title: "Expert Team", desc: "Years of experience across industries" },
                { icon: "💯", title: "100% Ownership", desc: "Full rights to all design files" },
                { icon: "🌍", title: "Global Experience", desc: "Trusted by clients worldwide" },
                { icon: "🔄", title: "Flexible Formats", desc: "Print, digital, and web-ready files" }
              ].map((item, idx) => (
                <motion.div
                  key={idx}
...
export default BrandIdentityDesignPage;
